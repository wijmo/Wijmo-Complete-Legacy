...
"use strict";(function(a){a.widget("wijmo.wijtooltip",{options:{content:"",title:"",closeBehavior:"auto",mouseTrailing:false,triggers:"hover",position:{my:"left bottom",at:"right top",offset:null},showCallout:true,showAnimation:{animated:"fade",duration:500},hideAnimation:{animated:"fade",duration:500},showDelay:150,hideDelay:150,calloutAnimation:{},calloutFilled:true,modal:false},_setOption:function(b,c){if(a.isPlainObject(c))c=a.extend(this.options[b],c);b==="position"&&this.element.data("oldPos",this.options[b]);a.Widget.prototype._setOption.apply(this,arguments);a.isFunction(this["_set_"+b])&&this["_set_"+b](c)},_setPositionOffset:function(j){var d=this.element.data("domElements"),c,h,e,i,b,g,f;d.callout.stop(true,true);c=a.extend({duration:1e3},this.options.calloutAnimation);h=this.element.data("arrowClass").replace(/wijmo-wijtooltip-arrow-/,"");e=false;i=["tr","tc","tl","bl","bc","br"];a.each(i,function(b,a){if(h===a)e=true});b="";g=this.options.position.offset;if(g){f=g.split(" ");if(f.length===2)if(e)b=f[0];else b=f[1]}if(b!=="")if(j)if(e)d.callout.css("left",b+"px");else d.callout.css("top",b+"px");else if(e)d.callout.animate({left:b},c.duration,c.easing);else d.callout.animate({top:b},c.duration,c.easing)},_set_triggers:function(){this.element.unbind(".tooltip");this._attachEventToElement()},_set_position:function(b){if(this.options.showCallout){if(!this.isCreateTooltip){this._createTooltip();this.isCreateTooltip=true}var a=this.element.data("oldPos");if(a.my!==b.my||a.at!==b.at){this._setCalloutCss();this._setposition()}this._setPositionOffset()}},_set_showCallOut:function(b){this.element.removeClass("wijmo-wijtooltip-arrow-tr wijmo-wijtooltip-arrow-tc wijmo-wijtooltip-arrow-tl wijmo-wijtooltip-arrow-br wijmo-wijtooltip-arrow-bc wijmo-wijtooltip-arrow-bl wijmo-wijtooltip-arrow-rb wijmo-wijtooltip-arrow-rc wijmo-wijtooltip-arrow-rt wijmo-wijtooltip-arrow-lb wijmo-wijtooltip-arrow-lc wijmo-wijtooltip-arrow-lt");var a=this.element.data("domElements");if(b){if(!this.isCreateTooltip){this._createTooltip();this.isCreateTooltip=true}this._setCalloutCss();a&&a.callout.show()}else a&&a.callout.hide()},_set_closeBehavior:function(){if(!this.isCreateTooltip){this._createTooltip();this.isCreateTooltip=true}this._setCloseBtnCss()},_set_mouseTrailing:function(){this.element.unbind(".tooltip");this._attachEventToElement()},destroy:function(){this.element.unbind(".tooltip");this.isCreateTooltip=false;a.Widget.prototype.destroy.apply(this);this.element.data("tooltip")&&this.element.data("tooltip").remove();this.element.attr("title",this.title);this.element.removeData("tooltip").removeData("arrowClass").removeData("domElements").removeData("fixedArrowClass").removeData("offset").removeData("oldPos").removeData("showDelay")},widget:function(){return this.element.data("tooltip")||this.element},_create:function(){this.element.data("oldPos",this.options.position);this.options.position.of=this.element;this._attachEventToElement();this.element.data("offset",this.options.position.offset);this.isCreateTooltip=false},_createTooltip:function(){this._setStructure();this._initializeDomElements();var a=this.element.data("domElements"),b=this.element.data("tooltip");this.element.attr("id")!==""&&b.attr("aria-describedby",this.element.attr("id"));b.hide();this._setCalloutCss();if(this.options.showCallout)a.callout.show();else a.callout.hide()},_setStructure:function(){var b=a("<div>"),f=a("<div class='wijmo-wijtooltip-container'>"),g=a("<div class='ui-widget-content wijmo-wijtooltip-pointer '><div class='wijmo-wijtooltip-pointer-inner'></div></div>"),d=a("<div>"),c=a("<a href='#'></a>"),e=a("<span>");b.addClass("wijmo-wijtooltip");c.addClass("wijmo-wijtooltip-close ui-state-default ui-corner-all");e.addClass("ui-icon ui-icon-close");c.append(e);this.element.data("domElements",{container:f,callout:g,closebtn:c,title:d});d.addClass("wijmo-wijtooltip-title ui-widget-header ui-corner-all");b.append(d);b.append(c);b.append(f);b.append(g);b.addClass("ui-widget ui-widget-content ui-corner-all");b.css("position","absolute").attr("role","tooltip");b.appendTo("body");this.element.data("tooltip",b);this._setCloseBtnCss()},_setCloseBtnCss:function(){var a=this.element.data("domElements");if(this.options.closeBehavior==="sticky")a.closebtn.show();else a.closebtn.hide()},_setCalloutCss:function(){if(!this.options.showCallout){this.options.position.offset=this.element.data("offset");return}var f=this.options,g=f.position.my,c,d,b=g.split(" "),a="",e;if(b.length===2){a+=b[0].substr(0,1);a+=b[1].substr(0,1)}c=f.position.at.split(" ");if(b[0]===c[0]){if(b[1]==="top"&&c[1]==="bottom"||b[1]==="bottom"&&c[1]==="top")a=a.substr(1,1)+a.substr(0,1)}else if(c[0]==="center")a=a.substr(1,1)+a.substr(0,1);if(a.substr(0,1)==="c")a=a.substr(1,1)+a.substr(0,1);if(this.element.data("arrowClass")){d=this.element.data("arrowClass");d=d.substr(d.length-2,1)}a="wijmo-wijtooltip-arrow-"+a;e=this.element.data("tooltip");e.removeClass("wijmo-wijtooltip-arrow-tr wijmo-wijtooltip-arrow-tc wijmo-wijtooltip-arrow-tl wijmo-wijtooltip-arrow-br wijmo-wijtooltip-arrow-bc wijmo-wijtooltip-arrow-bl wijmo-wijtooltip-arrow-rb wijmo-wijtooltip-arrow-rc wijmo-wijtooltip-arrow-rt wijmo-wijtooltip-arrow-lb wijmo-wijtooltip-arrow-lc wijmo-wijtooltip-arrow-lt");e.addClass(a);this.element.data("arrowClass",a)},_initializeDomElements:function(){var b=this.element.data("tooltip");b.bind("mouseout",a.proxy(this._onMouseOutTooltipElement,this));b.bind("mouseover",a.proxy(this._onMouseOverTooltipElement,this));this.element.data("domElements").closebtn.bind("click",a.proxy(this._onClickCloseBtn,this))},_attachEventToElement:function(){if(this.title===undefined){this.title=this.element.attr("title");this.element.attr("title","")}var a=this;this.element.unbind(".tooltip");this.options.mouseTrailing&&this.element.bind("mousemove.tooltip",function(){a._setposition();a.show()});switch(this.options.triggers){case"hover":this.element.bind("mouseover.tooltip",function(){a.show()}).bind("mouseout.tooltip",function(){if(a.options.closeBehavior==="sticky"||a.options.modal||a.options.closeBehavior==="none")return;a.hide()});break;case"click":this.element.bind("click.tooltip",function(){a.show()});break;case"focus":this.element.bind("focus.tooltip",function(){a.show()}).bind("blur.tooltip",function(){if(a.options.closeBehavior==="sticky")return;a.hide()});break;case"rightClick":this.element.bind("contextmenu.tooltip",function(b){a.show();b.preventDefault()})}},_isPointInsideRectWithOutBorder:function(c,e){var d=a(e),b={X:d.offset().left,Y:d.offset().top,Width:d.outerWidth(true),Height:d.outerHeight(true)};return c.X<=b.X||c.X>=b.X+b.Width?false:c.Y<=b.Y||c.Y>=b.Y+b.Height?false:true},_onMouseOutTooltipElement:function(a){if(this.options.closeBehavior==="sticky"||this.options.closeBehavior==="none")return;!this._isPointInsideRectWithOutBorder({X:a.pageX,Y:a.pageY},this.element.data("tooltip"))&&this.hide()},_onMouseOverTooltipElement:function(a){if(this.options.closeBehavior==="auto"&&!this.options.mouseTrailing)(!this.element.data("currentElement")||this._isPointInsideRectWithOutBorder({X:a.pageX,Y:a.pageY},this.element.data("currentElement")))&&this.hide()},_onClickCloseBtn:function(){this.hide()},_setposition:function(){var d=this.element.data("tooltip"),m=d.is(":hidden"),e,f,g,q,i,b,c,s,l,k,r,j,p,o,h,n;m&&d.show();e=a.extend(this.options.position,{});d.css({left:0,top:0});f="";if(this.options.showCallout){g=this.element.data("arrowClass");q=g.substr(g.length-2,2);i=q.split("");b=[];b[0]=b[1]=0;c=this.element.data("domElements");s=c.callout.css("border-top-width").replace(/px/g,"")*1;l=c.callout.css("border-left-width").replace(/px/g,"")*1;k=c.callout.css("border-right-width").replace(/px/g,"")*1;r=c.callout.css("border-bottom-width").replace(/px/g,"")*1;j=c.callout.css("top").replace(/px/g,"")*1;p=c.callout.css("left").replace(/px/g,"")*1;o=c.callout.css("right").replace(/px/g,"")*1;h=c.callout.css("bottom").replace(/px/g,"")*1;switch(i[0]){case"l":b[0]=k;break;case"r":b[0]=-l;break;case"b":b[1]=h;break;case"t":b[1]=-j}switch(i[1]){case"t":b[1]=-j;break;case"b":b[1]=h;break;case"r":b[0]=o;break;case"l":b[0]=-p}f=b.join(" ")}d.position({my:e.my,at:e.at,of:e.of,offset:f,collision:"none none"});n=d.offset();d.css({left:0,top:0});this.element.data("fixedArrowClass",false);d.position({my:e.my,at:e.at,of:e.of,offset:f,collision:e.collision});if(this.options.showCallout){this._calloutflip(n);this._set_unfilledCallout()}m&&!(this.options.relativeTo==="mouse"&&this.options.mouseTrailing)&&d.hide()},_set_unfilledCallout:function(b){if(!b){b=this.element.data("arrowClass");if(this.element.data("fixedArrowClass"))b=this.element.data("fixedArrowClass")}var c=this.element.data("tooltip"),d=this.element.data("domElements"),a=d.callout.children();a.css({"border-left-color":"","border-top-color":"","border-bottom-color":"","border-right-color":""});if(this.options.calloutFilled)switch(b){case"lt":case"lc":case"lb":a.css("border-right-color",c.css("background-color"));break;case"tl":case"tc":case"tr":a.css("border-bottom-color",c.css("background-color"));break;case"rt":case"rc":case"rb":a.css("border-left-color",c.css("background-color"));break;case"bl":case"bc":case"br":a.css("border-top-color",c.css("background-color"))}},_calloutflip:function(d){var e=this.element.data("tooltip"),c={left:false,top:false},g=a(window),f,b;if(this.options.position.at[0]!=="center"){if(d.left<0)c.left=true;f=d.left+e.width()-g.width()-g.scrollLeft();if(f>0)c.left=true}if(this.options.position[1]!=="center"){f=d.top+e.height()-g.height()-g.scrollTop();if(d.top<0)c.top=true;if(f>0)c.top=true}b=this.element.data("arrowClass");b=b.substr(b.length-2,2);if(c.left)if(b.indexOf("l")>-1)b=b.replace(/l/,"r");else if(b.indexOf("r")>-1)b=b.replace(/r/,"l");if(c.top)if(b.indexOf("t")>-1)b=b.replace(/t/,"b");else if(b.indexOf("b")>-1)b=b.replace(/b/,"t");if(c.left||c.top){e.removeClass("wijmo-wijtooltip-arrow-tr wijmo-wijtooltip-arrow-tc wijmo-wijtooltip-arrow-tl wijmo-wijtooltip-arrow-br wijmo-wijtooltip-arrow-bc wijmo-wijtooltip-arrow-bl wijmo-wijtooltip-arrow-rb wijmo-wijtooltip-arrow-rc wijmo-wijtooltip-arrow-rt wijmo-wijtooltip-arrow-lb wijmo-wijtooltip-arrow-lc wijmo-wijtooltip-arrow-lt");e.addClass("wijmo-wijtooltip-arrow-"+b)}this.element.data("fixedArrowClass",b)},_showTooltip:function(){var e=this.options,f,c,g,b,h={ui:this,cancel:false},d=this.element.data("tooltip");if(!d)return;this._trigger("showing",h);if(h.cancel)return;this._showModal();d.css("z-index",this._getMaxZIndex());if(e.showAnimation.animated&&!this.options.mouseTrailing){f={show:true,context:d,complete:a.proxy(function(){this._trigger("shown")},this)};c=a.wijmo.wijtooltip.animations;g=e.showAnimation.duration;b=e.showAnimation.animated;if(b&&!c[b]&&!a.easing[b])b="fade";if(!c[b])c[b]=function(a){this.slide(a,{easing:b,duration:g||700})};c[b](e.showAnimation,f)}else{d.show();this._trigger("shown")}this._setPositionOffset(true)},_hideTooltip:function(){var d=this.options,h=new a.Event("hidding.tooltip"),e,f,c,g,b;h.data={ui:this,cancel:false};this._trigger("hidding");if(h.data.cancel)return;this._hideModal();e=this.element.data("tooltip");if(d.hideAnimation.animated){f={show:false,context:e,complete:a.proxy(function(){this._trigger("hidden")},this)};c=a.wijmo.wijtooltip.animations;g=d.hideAnimation.duration;b=d.hideAnimation.animated;if(b&&!c[b]&&!a.easing[b])b="fade";if(!c[b])c[b]=function(a){this.slide(a,{easing:b,duration:g||700})};c[b](d.hideAnimation,f)}else{e.hide();this._trigger("hidden")}},_setText:function(){var b=this.element.data("domElements"),f,h=this.element,g,d,c,e=this.options.content,i=this;if(a.isFunction(e)){g=e.call(i.element,function(a){a&&b.container.html(a)});g&&b.container.html(g)}else if(e!=="")b.container.html(e);else b.container.html(h?this.title:"");b.title.show();d=this.options.title;c="";if(a.isFunction(d)){f=d.call(this.element,function(a){if(a)c=a});if(f)c=f}else if(d!=="")c=d;if(c!==""){b.title.show();b.title.html(c)}else b.title.hide()},_getMaxZIndex:function(){var b=0;a("*").each(function(){var c=a(this).css("z-index");if(!isNaN(c)){c=parseInt(c,10);if(c>b)b=c}});return b+1},_getDocHeight:function(){var b,c;if(a.browser.msie&&a.browser.version<7){b=Math.max(document.documentElement.scrollHeight,document.body.scrollHeight);c=Math.max(document.documentElement.offsetHeight,document.body.offsetHeight);return b<c?a(window).height()+"px":b+"px"}else return a(document).height()+"px"},_getDocWidth:function(){var b,c;if(a.browser.msie&&a.browser.version<7){b=Math.max(document.documentElement.scrollWidth,document.body.scrollWidth);c=Math.max(document.documentElement.offsetWidth,document.body.offsetWidth);return b<c?a(window).width()+"px":b+"px"}else return a(document).width()+"px"},_showModal:function(){if(this.options.modal){var b=a("<div>");b.addClass("ui-widget-overlay").css("z-index",this._getMaxZIndex()).width(this._getDocWidth()).height(this._getDocHeight());b.appendTo("body");this.element.data("modalDiv",b)}},_hideModal:function(){this.element.data("modalDiv")&&this.element.data("modalDiv").remove()},show:function(){if(!this.isCreateTooltip){this._createTooltip();this.isCreateTooltip=true}var b=this.element.data("tooltip");b.stop(true,true);this._setText();this.element.data("arrowClass")&&b.removeClass(this.element.data("arrowClass"));this._setCalloutCss();this._setposition();clearTimeout(this.element.data("showDelay"));this.element.data("showDelay",setTimeout(a.proxy(this._showTooltip,this),this.options.showDelay))},showAt:function(c){if(!this.isCreateTooltip){this._createTooltip();this.isCreateTooltip=true}var h=this.element.data("tooltip"),s,r,e,d,p,f,q,o,g,i,b,k,j,l,m,n;h.stop(true,true);this._setText();h.offset({left:0,top:0});h.show();e=0;d=0;p=this.element.data("arrowClass");f=this.element.data("domElements");e=f.callout.position().left;d=f.callout.position().top;q=f.callout.css("border-top-width").replace(/px/g,"")*1;o=f.callout.css("border-left-width").replace(/px/g,"")*1;s=f.callout.css("border-right-width").replace(/px/g,"")*1;r=f.callout.css("border-bottom-width").replace(/px/g,"")*1;g=o===0?s:o;i=q===0?r:q;b={};k=h.width();j=h.height();l=(this.options.position.collision||"flip").split(" ");if(l.length===1)l[1]=l[0];switch(p){case"wijmo-wijtooltip-arrow-rt":b.left=c.x-k-g;b.top=c.y-d;break;case"wijmo-wijtooltip-arrow-rc":b.left=c.x-k-g;b.top=c.y-j/2;break;case"wijmo-wijtooltip-arrow-rb":b.left=c.x-k-g;b.top=c.y-d-i;break;case"wijmo-wijtooltip-arrow-lt":b.left=c.x+g;b.top=c.y-d;break;case"wijmo-wijtooltip-arrow-lc":b.left=c.x-e;b.top=c.y-j/2;break;case"wijmo-wijtooltip-arrow-lb":b.left=c.x-e;b.top=c.y-d-i;break;case"wijmo-wijtooltip-arrow-tl":b.left=c.x-e;b.top=c.y-d;break;case"wijmo-wijtooltip-arrow-tc":b.left=c.x-k/2;b.top=c.y-d;break;case"wijmo-wijtooltip-arrow-tr":b.left=c.x-e-g;b.top=c.y-d;break;case"wijmo-wijtooltip-arrow-bl":b.left=c.x-e;b.top=c.y-j-i;break;case"wijmo-wijtooltip-arrow-bc":b.left=c.x-k/2;b.top=c.y-j-i;break;case"wijmo-wijtooltip-arrow-br":b.left=c.x-e-g;b.top=c.y-j-i}m=this._showAtflip(p,b);n=[];n[0]=m.substr(0,1);n[1]=m.substr(1,1);a.each(n,function(c,a){switch(a){case"l":b.left+=1;break;case"r":b.left-=1;break;case"t":b.top+=1;break;case"b":b.top-=1}});this._set_unfilledCallout(m);h.offset(b);h.hide();this.element.data("showDelay",setTimeout(a.proxy(this._showTooltip,this),this.options.showDelay))},_showAtflip:function(m,c){var f=(this.options.position.collision||"flip").split(" "),b,e,h,g,d,n,l,i,k,j;if(f[0]!=="flip"&&f[1]!=="flip")return;b=m.substr(m.length-2,2);e=this.element.data("tooltip");h=e.width();g=e.height();d=this.element.data("domElements");n=d.callout.css("border-top-width").replace(/px/g,"")*1;l=d.callout.css("border-left-width").replace(/px/g,"")*1;i=d.callout.css("border-right-width").replace(/px/g,"")*1;k=d.callout.css("border-bottom-width").replace(/px/g,"")*1;j=a(window);if(f[1]==="flip"){if(b.indexOf("t")>-1)if(c.top+g>j.height()){c.top-=g+k*2;b=b.replace(/t/,"b")}if(b.indexOf("b")>-1)if(c.top<0){c.top+=g+n*2;b=b.replace(/b/,"t")}}if(f[0]==="flip"){if(b.indexOf("l")>-1)if(c.left+h>j.width()){c.left-=h+i*2;b=b.replace(/l/,"r")}if(b.indexOf("r")>-1)if(c.left-i<0){c.left+=h+l*2;b=b.replace(/r/,"l")}}e.removeClass("wijmo-wijtooltip-arrow-tr wijmo-wijtooltip-arrow-tc wijmo-wijtooltip-arrow-tl wijmo-wijtooltip-arrow-br wijmo-wijtooltip-arrow-bc wijmo-wijtooltip-arrow-bl wijmo-wijtooltip-arrow-rb wijmo-wijtooltip-arrow-rc wijmo-wijtooltip-arrow-rt wijmo-wijtooltip-arrow-lb wijmo-wijtooltip-arrow-lc wijmo-wijtooltip-arrow-lt");e.addClass("wijmo-wijtooltip-arrow-"+b);return b},hide:function(){clearTimeout(this.element.data("showDelay"));clearTimeout(this.element.data("hideDelay"));this.element.data("hideDelay",setTimeout(a.proxy(this._hideTooltip,this),this.options.hideDelay))}});a.extend(a.wijmo.wijtooltip,{animations:{fade:function(b,c){b=a.extend({duration:300,easing:"swing"},b,c);b.context.stop(true,true).animate(b.show?{opacity:"show"}:{opacity:"hide"},b)}}})})(jQuery);
