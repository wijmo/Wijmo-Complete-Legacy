...
(function ($) {
    $.widget("ui.wijpager", {
        options: {
            ...
            /// Default: null.
            /// Type: Function.
            /// Code example: $("#element").wijpager( { pageindexchanging: function(e, args) { } } );
            /// </summary>
            ///
            ...
            /// Default: null.
            /// Type: Function.
            /// Code example: $("#element").wijpager( { pageindexchanged: function(e) { } } );
            /// </summary>
            ///
            /// <param name="e" type="EventObj">EventObj relates to this event.</param>
        ...
        _create: function () {
            this.element.addClass("ui-widget ui-wijpager ui-helper-clearfix");
        ...
        _init: function () {
            __wijReadOptionEvents(["pageindexchanging", "pageindexchanged"], this);
        },
        ...
        destroy: function () {
            ...
            ///	</summary>
            this.element.removeClass("ui-widget ui-wijpager ui-helper-clearfix");
            this.$ul.remove();
        ...
        _refresh: function () {
            ...
            this.element.append(this.$ul = $("<ul class=\"ui-list ui-corner-all ui-widget-content ui-helper-clearfix\"></ul>"));
        ...
        _createNextPrev: function (addFirstLast) {
            ...
            if (addFirstLast && this.options.pageIndex) {
                this.$ul.append(this._createPagerItem()
        ...
        _createNumeric: function (addFirstLast) {
            ...
            var endPageNumber = Math.min(this.options.pageCount, this.options.pageButtonCount);
            ...
            if (startPageNumber != 1) {
                // first button
                if (addFirstLast) {
                    this.$ul.append(this._createPagerItem().append(this._createPagerControl(1,
                        this.options.firstPageText, this.options.firstPageClass)));
                }

                // "..." button
                this.$ul.append(this._createPagerItem().append(this._createPagerControl(startPageNumber - 1, "...", "")));
            }

            // page numbers buttons
            for (var i = startPageNumber; i <= endPageNumber; i++) {
                var active = (i === currentPage);
                this.$ul.append(this._createPagerItem(active).append(this._createPagerControl(i, i.toString(), "", active)));
            }

            // "..." + last buttons
            if (this.options.pageCount > endPageNumber) {
                this.$ul.append(this._createPagerItem().append(this._createPagerControl(endPageNumber + 1, "...", "")));

                // last button
                if (addFirstLast) {
                    this.$ul.append(this._createPagerItem().append(this._createPagerControl(this.options.pageCount, this.options.lastPageText, this.options.lastPageClass)));
                }
            }
        },

        _createPagerItem: function (active) {
            var $li = $("<li />")
...
//                .css("textAlign", "left")
        ...
        _onClick: function (arg) {
            ...
            if (this._trigger("pageindexchanging", null, eventArg)) {
